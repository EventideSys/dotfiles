...
config.bind('ge', 'yank pretty-url')
...
config.set('colors.hints.bg', '#FAB387')
config.set('colors.hints.fg', '#181825')
config.set('colors.hints.match.fg', '#F5E0DC')
config.set('colors.keyhint.bg', '#FAB387')
config.set('colors.keyhint.fg', '#161320')
